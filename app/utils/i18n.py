...
BACKEND_TRANSLATIONS = {
    ...
    "message.reference.category2_confirm_prompt": {
        "zh-CN": "角色装扮图、布景状态图与关键动作参考图已生成完成，请确认是否满意。满意后请输入'确认'或点击继续按钮进入下一阶段。",
        "zh-TW": "角色裝扮圖、布景狀態圖與關鍵動作參考圖已生成完成，請確認是否滿意。滿意後請輸入「確認」或點擊繼續按鈕進入下一階段。",
        "en": "The character outfit images, backdrop state images, and key action reference images are ready. Please confirm. If they look good, enter 'confirm' or click Continue to proceed to the next stage.",
    ...
    "progress.reference.category2_completed_wait": {
        "zh-CN": "角色装扮图、布景状态图与关键动作参考图生成完成，等待用户确认...",
        "zh-TW": "角色裝扮圖、布景狀態圖與關鍵動作參考圖生成完成，等待使用者確認...",
        "en": "Character outfit images, backdrop state images, and key action reference images generated. Waiting for confirmation...",
    ...
    "step.reference.category2_complete": {
        "zh-CN": "🎨 角色装扮图、布景状态图与关键动作参考图已生成完成！请确认后继续。",
        "zh-TW": "🎨 角色裝扮圖、布景狀態圖與關鍵動作參考圖已生成完成！請確認後繼續。",
