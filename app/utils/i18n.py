...
BACKEND_TRANSLATIONS = {
    ...
    "message.reference.category2_confirm_prompt": {
        "zh-CN": "角色装扮图与布景状态图已生成完成，请确认是否满意。满意后请输入'确认'或点击继续按钮进入下一阶段。",
        "zh-TW": "角色裝扮圖與布景狀態圖已生成完成，請確認是否滿意。滿意後請輸入「確認」或點擊繼續按鈕進入下一階段。",
        "en": "The character outfit images and backdrop state images are ready. Please confirm. If they look good, enter 'confirm' or click Continue to proceed to the next stage.",
        "ja": "キャラクター衣装画像と背景セット状態画像の生成が完了しました。内容をご確認ください。問題なければ「confirm」と入力するか、続行ボタンを押して次の段階へ進んでください。",
        "es": "Las imágenes de vestuario de los personajes y las imágenes de estado de escenografía están listas. Confírmalas y, si están bien, escribe 'confirm' o pulsa Continuar para pasar a la siguiente etapa.",
    },
    ...
    "progress.reference.category2_completed_wait": {
        "zh-CN": "角色装扮图与布景状态图生成完成，等待用户确认...",
        "zh-TW": "角色裝扮圖與布景狀態圖生成完成，等待使用者確認...",
        "en": "Character outfit images and backdrop state images generated. Waiting for confirmation...",
        "ja": "キャラクター衣装画像と背景セット状態画像の生成が完了しました。確認待ちです...",
        "es": "Se generaron las imágenes de vestuario de los personajes y las imágenes de estado de escenografía. Esperando confirmación...",
    },
    ...
    "step.reference.category2_complete": {
        "zh-CN": "🎨 角色装扮图与布景状态图已生成完成！请确认后继续。",
        "zh-TW": "🎨 角色裝扮圖與布景狀態圖已生成完成！請確認後繼續。",
        "en": "🎨 The character outfit images and backdrop state images are complete. Confirm to continue.",
        "ja": "🎨 キャラクター衣装画像と背景セット状態画像の生成が完了しました。確認して続行してください。",
        "es": "🎨 Las imágenes de vestuario de los personajes y las imágenes de estado de escenografía están completas. Confirma para continuar.",
    },
